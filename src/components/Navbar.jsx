...
export const Navbar = () => {
  ...
  return (
    ...
    <ul className={`${menuClicked ? 'flex' : 'hidden'} bg-white py-[39px] w-[329px] h-[305px] absolute left-0 right-0 mx-auto top-[106px] flex-col items-center place-content-around
        ...
        text-very-dark-grayish-blue text-xl z-10
